...
export const warehouseDetailData = {
  meta: {
    title: "Warehouse and Corporate Solutions in Coimbatore | Vizhi Infragen Realtors",
    description:
      "Trusted warehouse and corporate property solutions in Coimbatore. Industrial godowns, corporate office space, logistics hubs, and commercial land for sale and lease.",
    keywords: [
      "Warehouse and Corporate Solutions in Coimbatore",
      "Godowns for lease Coimbatore",
      "Industrial land Coimbatore",
      "Corporate office space Coimbatore",
      "Logistics property Coimbatore",
      "Vizhi Infragen Realtors",
    ],
  },
  hero: {
    tagline: "INDUSTRIAL & CORPORATE PROPERTY SOLUTIONS",
    title: "Warehouse & Corporate Solutions in",
    titleHighlight: "Coimbatore",
    subtext: "Trusted Plots and Land for Sale in Coimbatore",
    backgroundImage: "/assets/images/service-10.jpg",
  },
  premierDesk: {
    tagBadge: "Warehouse & Corporate Desk",
    ...
    bentoCards: {
      largeCard: {
        ...
        subtitle: "Industrial & Office Spaces",
  ...
  cta: {
    ...
    buttonLink: "/contact?service=warehouse",
