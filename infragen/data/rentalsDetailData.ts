...
export const rentalsDetailData = {
  meta: {
    title: "Rental Services in Coimbatore | Vizhi Infragen Realtors",
    description:
      "Trusted rental services and land for sale in Coimbatore. Tenant sourcing, lease drafting, property management, residential and commercial rental solutions.",
    keywords: [
      "Rental Services in Coimbatore",
      "House for rent Coimbatore",
      "Commercial space for rent Coimbatore",
      "Land for sale in Coimbatore",
      "Saravanampatti rentals",
      "Vizhi Infragen Realtors",
    ],
  },
  hero: {
    tagline: "LEASING & RENTAL MANAGEMENT SERVICES",
    title: "Rental Services in",
    titleHighlight: "Coimbatore",
    subtext: "Trusted Plots and Land for Sale in Coimbatore",
    backgroundImage: "/assets/images/service-9.jpg",
  },
  premierDesk: {
    tagBadge: "Rental Services Desk",
    ...
    bentoCards: {
      largeCard: {
        ...
        subtitle: "Leasing & Tenant Desk",
        image: "/assets/images/service-9.jpg",
      },
      smallCard1: {
        title: "Tenant Sourcing",
        subtitle: "Verified Background",
  ...
  cta: {
    ...
    buttonLink: "/contact?service=rentals",
